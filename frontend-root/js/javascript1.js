...
//Persigue al jugador
		tans1.position.x += Math.sin(camara.rotation.y) * (player.speed);
		tans1.position.z += -Math.cos(camara.rotation.y) * (player.speed);
		tans2.position.x += Math.sin(camara.rotation.y) * (player.speed);
		tans2.position.z += -Math.cos(camara.rotation.y) * (player.speed);

		tans4.position.x += Math.sin(camara.rotation.y) * (player.speed);
		tans4.position.z += -Math.cos(camara.rotation.y) * (player.speed);
...
var ambientLight = new THREE.AmbientLight(new THREE.Color(0, 0.5, 1), 1.0);
escena.add(ambientLight);




adios = new THREE.DirectionalLight(new THREE.Color(0.5, 0.7, 1), 1);
adios.position.set(1, 1, 0);


hola = new THREE.DirectionalLight(new THREE.Color(0, 1, 0), 1);
hola.position.set(1, 0, 1);
escena.add(hola);
escena.add(adios);
